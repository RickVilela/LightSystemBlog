<?php
  ...
  if(isset($_FILES['arquivo'])){
    ...
    $novo_nome = $_POST['autor']. "_". md5(time()) . $extensao; //define o nome do arquivo
    ...
    $sql_code = "INSERT INTO posts ( titulo , descricao, caminhoImg, autor, categoria) VALUES('$titulo', '$descricao', '$caminhoImg', '$autor', '$categoria')";
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admin.php">
                ...
                <div class="sidebar-brand-text mx-3">News Light System</div>
            </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-9 ml-3">
                            <form class="row g-3" action="<?=base_url('')?>admin" method="POST" enctype="multipart/form-data">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-8">
                                    <label for="file" class="form-label"> Imagem Post </label>
